...
# Resolve relative to this file: tools/execute_sql.py → parent.parent = agent root.
# On Cloud, enterprise.sqlite lives at the agent root alongside agent.yaml.
# Locally, start.py overrides via the ENTERPRISE_DB_PATH env var.
